...
const Exercise = (props) =>{
  ...
  //console.log('This are props.deleteExercise(props.exercise._id) username ', props.deleteExercise())
  return (
  <tr>
    ...
    <td>
      <Link to={"/edit/"+props.exercice._id}>edit</Link> | <a href="#" onClick={() => {props.deleteExercise(props.exercice._id)}}>Delete</a>
    </td>
  </tr>
  )}
...
export const ExercisesList = () => {
  ...
  useEffect(()=>{
    ...
    // console.log('This is inside getExercisesLsitfromDB Inside exercisesList:', exercices);
